...
<body>
	<form class="form"  action="operazioniTecnici.php" method="post">
    	<br />
        ...
        ?>
       	...
       	<br /><br /><br />
    	<button class="buttfiltro" name="aggiungere" value="aggiungere" type="submit" id="aggiungere">Registra tecnico</button>
	</form>
    <br /><br /><br />
    <hr class="separator">
    <form class="form"  action="operazioniTecnici.php" method="post">
    	<br />
    	<span class="visClient">Rimuovere un tecnico</span><br /><br /><br />
        	...
        	if(isset($_POST['rimuovere'])===true){
                ...
                if($result->num_rows === 1){
                    ...
                    if(!($result === false) === true) {
                    	...
                    	$str = '<span class="filtra">Tecnico non rimosso, si è verifica un problema</span>';
                        echo $str;
                    }
                } else {
                	$str = '<span class="filtra">Tecnico non rimosso, nessun tecnico ha ID: '.$id.'</span>';
                    echo $str;
                }
            }
        ?>
    	<button class="buttfiltro" name="rimuovere" value="rimuovere" type="submit" id="rimuovere">Rimuovi tecnico</button>
    </form>
    <br /><br /><br />
    <hr class="separator">
    <form class="form"  action="operazioniTecnici.php" method="post">
    	<br />
    	<span class="visClient">Modificare i dati di un tecnico</span><br /><br /><br />
        <div class= "contenitorecolonna">
        <table class="tabellacolonna">
        	<tbody>
            	<tr>
    	...
    	<button class="buttfiltro" name="recuperare" value="recuperare" type="submit" id="recuperare">Recupera i dati del tecnico</button>
    </form>
    <br /><br />
	<form class="form"  action="operazioniTecnici.php" method="post">
    	<br />
        <?php
            ...
            if(isset($_POST['recuperare'])===true){
                ...
                $result = $conn->query($query);
                if($result->num_rows === 1){
                	$str = '<span class="filtra">Recuperati i dati del tecnico con ID: '.$id.'</span>';
                    echo $str;
                } else {
                	$str = '<span class="filtra">Non è presente nessun tecnico con ID: '.$id.'</span>';
                    echo $str;
                }
            }
        ?>
    	...
    	<button class="buttfiltro" name="salvare" value="salvare" type="submit" id="salvare" 
        	...
        	?> 
        >Salva i dati del tecnico</button>
